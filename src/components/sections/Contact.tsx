          ...
          <div className="bg-natural-white rounded-2xl p-8 shadow-lg border border-pink-lavender/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full font-oswald text-natural-white bg-goldenrod hover:bg-pink-lavender disabled:bg-gray-400 px-8 py-4 rounded-lg text-lg font-bold tracking-wide transition-colors duration-300 flex items-center justify-center space-x-2"
              >
